                                ...
                                <div className="card mb-4">
                                    ...
                                    <form>
                                        ...
                                        <div className="col-sm-10">
                                            <input type="text" maxlength="5" className="form-control" id="basic-default-name" placeholder="ej. M-345" />
                                        </div>
                                        </div>

                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-company"> Marca</label>
                                        <div className="col-sm-10">
                                            <input
                                            type="text"
                                        ...
                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-name">Modelo</label>
                                        <div className="col-sm-10">
                                            <input type="text" className="form-control" id="basic-default-name" placeholder="Ingrese el modelo del vehículo"/>
                                        </div>
                                        </div>

                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-name">Color</label>
                                        <div className="col-sm-10">
                                            <input type="text" className="form-control" id="basic-default-name" placeholder="Ingrese el color del vehículo" />
                                        </div>
                                        </div>

                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-name">Placa</label>
                                        <div className="col-sm-10">
                                            <input type="text" className="form-control" maxlength="7" id="basic-default-name" placeholder="Ingrese el no. de placa del vehículo" />
                                        </div>
                                        </div>

                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-name">Chasis</label>
                                        <div className="col-sm-10">
                                            <input type="text" className="form-control" maxlength="17" id="basic-default-name" placeholder="Ingrese el no. de chasis del vehículo" />
                                        </div>
                                        </div>

                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-name">Tipo de Vehículo</label>
                                        <div className="col-sm-10">
                                            <input type="text" className="form-control" id="basic-default-name" placeholder="ej.: Furgón" />
                                        </div>
                                        </div>

                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-name">Tipo de Seguro</label>
                                        <div className="col-sm-10">
                                            <select className="form-control" id="basic-default-name"></select>
                                        </div>
                                        </div>

                                        <div className="row mb-3">
                                        <label className="col-sm-2 col-form-label" for="basic-default-name">Status</label>
                                        <div className="col-sm-10">
                                            <select className="form-control" id="basic-default-name"></select>
                                        </div>
                                        </div>
